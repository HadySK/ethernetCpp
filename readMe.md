...
Ethernet Frame has a header of 14 bytes, plus a minimum of 46 bytes for the payload.
...
pip install scapy
```
Enter the command below in PowerShell to send packet
```
...
we can also send ICMP packet (ping) using IPv4, in PowerShell enter
